...
def get_train_joint_transform_wild(args, dataset):
    """
    ...
    train_joint_transform_list = []
    train_joint_transform_list += [
        standard_transforms.Resize(args.crop_size),
        standard_transforms.RandomCrop(args.crop_size),
        standard_transforms.RandomHorizontalFlip()]

    train_joint_transform = standard_transforms.Compose(train_joint_transform_list)
